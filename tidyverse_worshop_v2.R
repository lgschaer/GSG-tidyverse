...
housing <- read_csv("/home/lgschaer/old/GSG-tidyverse/landdata-states.csv")
head(housing)
...
dat <- read_csv("/home/lgschaer/old/GSG-tidyverse/EconomistData.csv")
head(dat)
...
#change title on x axis, adjust scale and axis limits
p5 <- p4 +
...
#change title on y axis, adjust scale and axis limits
p6 <-p5 +
...
#change to custom color scale, change region labels
p7 <- p6+
